...
import 'add_album_screen.dart';     // Import màn hình thêm album
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          // Thêm scroll để không bị tràn màn hình
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Card(
                  ...
                  child: ListTile(
                    leading: const Icon(
                      Icons.album, // Icon cái đĩa Album
                      color: Colors.tealAccent,
                    ),
                    title: const Text(
                      "Thêm album mới",
                    ...
                    onTap: () {
                      // Chuyển sang màn hình thêm Album
                      Navigator.push(
                        context,
                        MaterialPageRoute(
